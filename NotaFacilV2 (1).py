...
st.set_page_config(page_title="Controle Escolar - NotaFacil", page_icon="🎓", layout="wide")
...
if menu == "📋 Cadastro de Alunos":
    ...
    st.markdown("Insira o nome do aluno, a turma e adicione suas notas divididas.")
    ...
    with st.form(key="form_aluno", clear_on_submit=True):
        ...
        with col_cad_info_2:
            turma = st.text_input("Turma:", placeholder="Ex: 9º Ano A ou 3º Colegial")
